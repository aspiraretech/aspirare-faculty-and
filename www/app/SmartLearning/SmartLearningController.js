...
angular.module('smartFacultyApp')
    .controller('SmartLearningController', function($scope, $state, LoginFactory, LessonPlanFactory, $ionicHistory, $ionicModal, $timeout, SmartLearningFactory, ionicToast, $sce, TopicDetailsFactory, $cordovaInAppBrowser) {
        ...
        $scope.nextQuestion = function() {
            if ($scope.questions[$scope.currentIndex + 1] != undefined) {
                ...
                ionicToast.show('You have successfully completed all the MCQs!', 'bottom', false, 2500);
                $state.go('topicDetails');
            }
        };
