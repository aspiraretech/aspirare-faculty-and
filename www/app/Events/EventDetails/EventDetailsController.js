...
angular.module('smartFacultyApp')
    .controller('EventDetailsController', function($scope, $state, EventsFactory, ionicToast, $ionicPopup, $ionicHistory, $q, $sce, $ionicLoading, $cordovaFileTransfer, $cordovaSocialSharing, LoginFactory, $cordovaInAppBrowser) {
            ...
            EventsFactory.getEventImages($scope.event.Id)
                .then(function(success) {
                    if (success.data.Code != "S001") {
                        ionicToast.show('There are no images attached for this Notice', 'bottom', false, 2500);
                    } else {
